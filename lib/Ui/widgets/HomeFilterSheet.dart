...
//   final int rating; // 2..4 shown as sample
//   final bool selected;
...
//           const Text('& up', style: TextStyle(color: Colors.black87)),
//           const Spacer(),
//           RadioTheme(
//             data: RadioThemeData(
...
//                   return Colors.black;
//                 }
//                 return Colors.black54; // visible ring when unselected
//               }),
//               materialTapTargetSize: MaterialTapTargetSize.shrinkWrap,
//             ),
//             child: Radio<int>(
//               value: rating,
//               groupValue: selected ? rating : null,
